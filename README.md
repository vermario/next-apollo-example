...
This example relies on [graph.cool](http://graph.cool) for its GraphQL backend and [Styled Components](https://styled-components.com/) for it's CSS-in-JS solution.
